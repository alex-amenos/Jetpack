...
internal class LocationRepositoryImpl(
    ...
    override val locationSharedFlow: SharedFlow<Location> = locationDataSource.locationSharedFlow
    ...
    override suspend fun startLocationProvider(locationParameters: LocationParameters) = locationDataSource.startLocationProvider(locationParameters)

    override suspend fun stopLocationProvider() = locationDataSource.stopLocationProvider()
}
