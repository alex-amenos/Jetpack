    ...
    AppTheme {
        Box(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.movies_not_selected_title),
                ...
                Text(
                    text = stringResource(R.string.movies_not_selected_detail),
...
@PreviewLightDark
@Composable
private fun MovieNotSelectedComposablePreview() {
